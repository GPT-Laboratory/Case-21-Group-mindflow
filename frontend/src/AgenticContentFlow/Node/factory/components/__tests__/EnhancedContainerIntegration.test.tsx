    ...
    if (nodeType === 'container-test') {
      return {
        ...
        handles: {
          category: 'utility',
          definitions: [
            { position: 'left', type: 'target', dataFlow: 'data', icon: 'ArrowLeft' },
            { position: 'right', type: 'source', dataFlow: 'data', icon: 'ArrowRight' }
          ]
        },
...
vi.mock('@jalez/react-state-history', () => ({
  ...
  useTrackableState: (_key: string, setter: any) => setter
}));
