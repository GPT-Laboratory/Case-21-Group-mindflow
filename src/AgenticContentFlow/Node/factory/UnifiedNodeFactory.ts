...
import { UnifiedFrameJSON, UnifiedNodeInstanceData } from './types/UnifiedFrameJSON';
...
export class UnifiedNodeFactory {
   ...
   */
  static validateConfig(config: UnifiedFrameJSON): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
